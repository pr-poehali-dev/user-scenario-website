...
const tests = [
  {
    ...
    questions: [
      ...
      'Я быстро устаю',
      'У меня бывает учащённое сердцебиение',
  ...
  },
  {
    ...
    questions: [
      ...
      'У меня проблемы со сном (бессонница или чрезмерная сонливость)',
      ...
      'Я чувствую безнадёжность по поводу будущего',
    ],
  },
];
